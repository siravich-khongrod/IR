...
<link rel="stylesheet" href="simple-job-board.css" type="text/css" media="all">
...
<div style="margin-top:50px;margin-bottom: 0px; text-align:center;height:100px">
		<img src="home_title.png" id="home_title_image" alt="title">
...
<div class="row">
    <div class="job-detail">        
        <h3><span class="job-title" style="color: 	#FF4500;    margin: 0;
    padding: 0;
    border: 0;
    font-size: 100%;
    font: inherit;
			...
			<form class="jobpost-form" id="sjb-application-form" name="c-assignments-form" enctype="multipart/form-data" action="resumesubmit.php" method="post" onsubmit="startUpload();">
				<div class="row">
					<div class="col-md-12">
						...
						<div> <input type="hidden" id="vhphoto" name="vhphoto" value="736dd0cfc9e1a650040b17fdc417c71e"> </div>
						<div id="">
							<label>Select File</label><br>
							<input type="file" name="file" id="file" class="sjb-attachment form-control valid" required="">
							<input type="hidden" id="filename" name="filename" value="736dd0cfc9e1a650040b17fdc417c71e">
